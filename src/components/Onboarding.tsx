...
const steps = [
  {
    ...
    icon: "✨",
    content:
      "Открывайте, организуйте и будьте в курсе персонализированных новостей из ваших любимых источников.",
  },
  {
    ...
    icon: "📰",
    content:
      "Нажмите на иконку настроек, чтобы добавить RSS-ленты. Поддерживается до 15 источников новостей.",
  },
  {
    ...
    icon: "🔍",
    content:
      "Используйте ключевые слова для фильтрации статей. Наш ИИ понимает контекст и показывает самые релевантные истории.",
  },
  {
    ...
    icon: "⭐",
    content:
      "Нажмите на иконку сердца, чтобы сохранить статьи. Наш ИИ учится на ваших выборах и рекомендует похожий контент.",
  },
  {
    ...
    icon: "🤖",
    content:
      "Когда вы сохраняете статьи, наш ИИ анализирует ваши предпочтения и предлагает похожие истории, которые вам понравятся.",
  },
];
          ...
          <div className="flex gap-2">
            {steps.map((_, index) => (
              <div
                ...
                style={{
                  background:
                    index === currentStep ? "var(--accent)" : "var(--surface)",
